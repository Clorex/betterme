          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.div
                ...
                className="fixed top-16 right-4 w-44 bg-white dark:bg-brand-surface rounded-xl shadow-2xl border border-gray-200 dark:border-brand-surface-light overflow-hidden z-[9999]"
              >
                <button
                  onClick={() => {
                    setMenuOpen(false);
