    ...
    <div className="flex flex-col h-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Tell us about yourself so we can create your plan.
        </p>
      </div>
            ...
            <div className="flex bg-gray-100 dark:bg-brand-surface-light rounded-2xl p-1">
              <button
                ...
                className={cn(
                  ...
                  data.heightUnit === "cm" ? "bg-brand-purple text-white" : "text-gray-500"
                )}
              >
                cm
              </button>
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-xl text-sm font-semibold transition-all",
                  data.heightUnit === "ft" ? "bg-brand-purple text-white" : "text-gray-500"
                )}
              >
                ft
              </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex bg-gray-100 dark:bg-brand-surface-light rounded-2xl p-1">
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-xl text-sm font-semibold transition-all",
                  data.weightUnit === "kg" ? "bg-brand-purple text-white" : "text-gray-500"
                )}
              >
                kg
              </button>
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-xl text-sm font-semibold transition-all",
                  data.weightUnit === "lbs" ? "bg-brand-purple text-white" : "text-gray-500"
                )}
              >
                lbs
              </button>
