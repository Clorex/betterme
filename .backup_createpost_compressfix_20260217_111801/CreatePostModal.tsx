...
const postTypes = [
  { id: 'progress', label: 'Progress', icon: Target, emoji: '💪' },
  { id: 'question', label: 'Question', icon: HelpCircle, emoji: '❓' },
  { id: 'tip', label: 'Tip', icon: Lightbulb, emoji: '💡' },
  { id: 'milestone', label: 'Milestone', icon: Trophy, emoji: '🎉' },
  { id: 'transformation', label: 'Transformation', icon: Flame, emoji: '🔥' },
] as const;
